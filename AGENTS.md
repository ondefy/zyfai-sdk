...
Canonical agent instructions for this repository. Edit this file only. `CLAUDE.md` imports it for Claude Code; Cursor, Codex, Copilot, and similar tools read `AGENTS.md` directly.
