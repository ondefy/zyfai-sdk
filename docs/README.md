...
| Generated API (local) | `npm run docs` → `docs/api/` (gitignored) |
| Public site | [docs.zyf.ai](https://docs.zyf.ai) (`ondefy/sdk-api-docs` repo) |

Agent entry: [`../AGENTS.md`](../AGENTS.md). Validation: `npm run check`.
